...
namespace HotelManagementSystem.Services.Migrations
{
    ...
    [Migration("20241120205437_Session")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManagementSystem.Interfaces.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HotelManagementSystem.Interfaces.Entities.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HotelManagementSystem.Interfaces.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("HotelManagementSystem.Interfaces.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("HotelManagementSystem.Interfaces.Entities.User", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelManagementSystem.Interfaces.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
